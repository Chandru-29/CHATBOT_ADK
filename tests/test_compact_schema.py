"""
test_compact_schema.py — Unit tests for Compact Schema Notation (CSN) schema generation.
"""
...
def test_sql_agent_missing_table_compatibility():
...
def test_indexer_build_rich_table_doc_csn():
